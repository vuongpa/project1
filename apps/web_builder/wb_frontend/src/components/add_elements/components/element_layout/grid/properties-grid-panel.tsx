...
export const GridProperties: React.FC<GridPropertiesProps> = ({ properties, onPropertyChange, size = "small" }) => {
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 0.5 }}>
                {section.details.includes("columns") && (
                  <Box display="flex" alignItems="center" gap={0.5}>
                    <Typography variant="caption" sx={{ minWidth: 80, color: "white", fontSize: "10px" }}>Columns</Typography>
                    <TextField
                      id="columns"
                      label=""
                      type="number"
                      value={properties.columns}
                      onChange={(e) => handleChange("columns", parseInt(e.target.value, 10) || 1)} // Đảm bảo giá trị là số nguyên dương
                      variant="standard"
                      size={size}
                      sx={{
                ...
                {section.details.includes("rows") && (
                  <Box display="flex" alignItems="center" gap={0.5}>
                    <Typography variant="caption" sx={{ minWidth: 80, color: "white", fontSize: "10px" }}>Rows</Typography>
                    <TextField
                      id="rows"
                      label=""
                      type="number"
                      value={properties.rows}
                      onChange={(e) => handleChange("rows", parseInt(e.target.value, 10) || 1)} // Đảm bảo giá trị là số nguyên dương
                      variant="standard"
                      size={size}
                      sx={{
                        "& .MuiInputBase-input": { color: "white", fontSize: "10px" },
                        ...
                        "& .MuiInput-underline:hover:not(.Mui-disabled):before": { borderBottomColor: "white" },
                        height: "24px",
                        width: "120px", // Giới hạn chiều rộng để tránh tràn
                      }}
                    />
                  </Box>
                )}
                {section.details.includes("gap") && (
                  <Box display="flex" alignItems="center" gap={0.5}>
                    <Typography variant="caption" sx={{ minWidth: 80, color: "white", fontSize: "10px" }}>Gap</Typography>
                    <TextField
                      id="gap"
                      label=""
                      type="text"
